...
export function MacbookScrollDemo() {
  return (
    <div className="overflow-hidden sm:translate-y-0 translate-y-48 h-[50rem] sm:h-full w-full dark:bg-customblack bg-white  dark:bg-grid-white/[0.2] bg-grid-customblack/[0.2] relative flex items-center justify-center">
