        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <Link
              ...
              duration={3000}
              onSetActive={handleSetActive}
              className="hidden sm:block border text-sm font-medium relative border-neutral-200 dark:border-white/[0.2] text-black dark:text-customwhite px-4 py-2 rounded-full"
            >
              <span>Contact</span>
